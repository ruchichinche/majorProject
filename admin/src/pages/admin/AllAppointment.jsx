...
useEffect(()=>{
    ...
    return(
        <div className="w-full max-w-6xl m-5"> 
            ...
            <div className="bg-white border rounded text-sm max-h-[80vh] min-h-[60vh] overflow-auto">
                <div className="hidden sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-5 border-b font-medium text-gray-600">
                    <p>#</p>
                    <p>Patient</p>
                    <p>Age</p>
                    <p>Date & Time</p>
  ...
  <div key={index} className="flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500  py-3 px-6  border-b hover:bg-gray-100">
    ...
    <p>{item.slotDate} {item.slotTime}</p> 
     <div className="flex items-center gap-2">
        <img className="w-8  rounded-full" src={item.doctorData.image} alt="" />
